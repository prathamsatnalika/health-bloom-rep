...
import 'package:health_bloom_test_ui/screens/Scheduler/database/repository.dart';
import 'package:health_bloom_test_ui/screens/Scheduler/helpers/snack_bar.dart';
import 'package:health_bloom_test_ui/screens/Scheduler/models/medicine_type.dart';
import 'package:health_bloom_test_ui/screens/Scheduler/models/pill.dart';
import 'package:health_bloom_test_ui/screens/Scheduler/notifications/notifications.dart';
import 'package:health_bloom_test_ui/screens/Scheduler/screens/add_new_medicine/form_fields.dart';
import 'package:health_bloom_test_ui/screens/Scheduler/screens/add_new_medicine/medicine_type_card.dart';
...
class _AddNewMedicineState extends State<AddNewMedicine> {
  ...
  final List<MedicineType> medicineTypes = [
    MedicineType("Syrup", Image.asset("images/syrup.png"), true),
    MedicineType(
        "Pill", Image.asset("images/pills.png"), false),
    MedicineType(
        "Capsule", Image.asset("images/capsule.png"), false),
    MedicineType(
        "Cream", Image.asset("images/cream.png"), false),
    MedicineType(
        "Drops", Image.asset("images/drops.png"), false),
    MedicineType(
        "Syringe", Image.asset("images/syringe.png"), false),
  ];
  ...
  Widget build(BuildContext context) {
    ...
    appBar: AppBar(
        title: Text("Add Pills ",style: TextStyle(
            color: Colors.white
        ),),
